...
if defined?(Jasminerice) == 'constant'
  Jasminerice.setup do |config|
    # Tell Jasminerice to automatically mount itself in your application. If
    # set to false, you must manually mount the engine in order to use
    # Jasminerice.
    #config.mount = true
    ...
    # Specify a path where your fixutures can be found. Defaults to
