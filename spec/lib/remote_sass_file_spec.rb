...
describe RemoteSassFile do
  ...
  after :each do
    if File.exists?(@remote_sass_file.css_file_path)
      FileUtils.rm(@remote_sass_file.css_file_path) 
    end
  end
  ...
  describe "#scss_file_name" do
    it "should return the file name" do
      @remote_sass_file.scss_file_name.should == "remote_sass_file.scss"
    end
  end
  ...
  describe "#css_dir" do
    it "should include /public/stylesheets" do
      @remote_sass_file.css_dir.should include "public/stylesheets"
    end
  end
  describe "#css_file_path" do
    it "should include the stylesheet file name" do
      @remote_sass_file.css_file_path.should include @remote_sass_file.css_file_name
    end
  end
  describe "#css_link_path" do
    it "should include the styleheet file name" do
      @remote_sass_file.css_link_path.should include @remote_sass_file.css_file_name
    end
  end
  describe "#compile_colors" do
    before :each do
      ...
      @remote_sass_file.compile_colors
    end
  ...
  describe "#compile_self" do
    before :each do
      ...
      @remote_sass_file.compile_colors
      @remote_sass_file.compile_self
    end
    it "write file to public/stylesheets" do
      File.exists?(@remote_sass_file.css_file_path).should be_true
    end
  end
  describe "#compile" do
