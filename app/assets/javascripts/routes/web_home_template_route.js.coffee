App.WebHomeTemplateRoute = Ember.Route.extend
  setupController: (controller, model) ->
    ...
    @controllerFor("asideBeforeWidgets").set("model", model.get("website.websiteTemplate.asideBeforeWidgets"))
    @controllerFor("asideAfterWidgets").set("model", model.get("website.websiteTemplate.asideAfterWidgets"))
